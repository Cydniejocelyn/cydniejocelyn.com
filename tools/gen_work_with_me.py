...
FAQ = [
 ...
 ("How do I start working with you?", "Book a free 30-minute call. If we are a fit, the next step is the Sounding, a 90-minute strategy session with a written plan two days later. The $300 comes off your project."),
...
menu = '''
  ...
  item("The Sounding", "A 90-minute strategy session on the whole business, then a written plan two days later: what is load bearing, and what to do first. The fee comes off your project.", [], price("Flat", "$300"), link='<a class="hv-link" href="%s">Book the Sounding</a>' % SOUND),
...
<section class="hv-sec ww-path" aria-labelledby="ww-path">
  <div class="hv-wrap">
    ...
    <ol class="ww-steps" role="list">
      ...
      <li><h3>The Sounding</h3><p>A 90-minute strategy session, then a written plan two days later with your first move.</p><span class="hv-meta">$300, credited to your project</span></li>
